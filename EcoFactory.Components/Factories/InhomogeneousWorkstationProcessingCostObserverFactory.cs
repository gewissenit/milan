...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationProcessingCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
    ...
    {
      return new CostObserverExtensions.InhomogeneousWorkstation.Processing();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousWorkstation.Processing);
    }
    ...
    {
      var observer = (CostObserverExtensions.InhomogeneousWorkstation.Processing) simulationObserver;
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousWorkstation.Processing) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousWorkstation.Processing();
