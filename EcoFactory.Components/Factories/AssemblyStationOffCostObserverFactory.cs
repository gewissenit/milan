...
namespace EcoFactory.Components.Factories
{
  ...
  internal class AssemblyStationOffCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new CostObserverExtensions.AssemblyStation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.AssemblyStation.Off);
    }
    ...
    {
      var master = (CostObserverExtensions.AssemblyStation.Off) costObserver;
      var clone = new CostObserverExtensions.AssemblyStation.Off();
