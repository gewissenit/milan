...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationOffCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousWorkstation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousWorkstation.Off);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousWorkstation.Off) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousWorkstation.Off();
