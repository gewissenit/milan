...
namespace EcoFactory.Components.Factories
{
  ...
  internal class AssemblyStationBlockedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new MaterialObserverExtensions.AssemblyStation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.AssemblyStation.Blocked);
    }
    ...
    {
      var master = (MaterialObserverExtensions.AssemblyStation.Blocked) costObserver;
      var clone = new MaterialObserverExtensions.AssemblyStation.Blocked();
