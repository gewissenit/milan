...
namespace EcoFactory.Components.Factories
{
  ...
  internal class AssemblyStationProcessingCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
    ...
    {
      return new CostObserverExtensions.AssemblyStation.Processing();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.AssemblyStation.Processing);
    }
    ...
    {
      var observer = (CostObserverExtensions.AssemblyStation.Processing) simulationObserver;
    ...
    {
      var master = (CostObserverExtensions.AssemblyStation.Processing) costObserver;
      var clone = new CostObserverExtensions.AssemblyStation.Processing();
