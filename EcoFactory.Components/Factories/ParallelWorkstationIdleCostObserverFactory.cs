...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationIdleCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new CostObserverExtensions.ParallelWorkstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.ParallelWorkstation.Idle);
    }
    ...
    {
      var master = (CostObserverExtensions.ParallelWorkstation.Idle) costObserver;
      var clone = new CostObserverExtensions.ParallelWorkstation.Idle();
