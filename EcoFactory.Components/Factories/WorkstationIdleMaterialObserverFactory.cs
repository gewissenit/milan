...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationIdleMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new MaterialObserverExtensions.Workstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.Workstation.Idle);
    }
    ...
    {
      var master = (MaterialObserverExtensions.Workstation.Idle) costObserver;
      var clone = new MaterialObserverExtensions.Workstation.Idle();
