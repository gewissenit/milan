...
namespace EcoFactory.Components.Factories
{
  ...
  internal class EntryPointEnteredMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Entered"; }
    ...
    {
      return new MaterialObserverExtensions.EntryPoint.Entered();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.EntryPoint.Entered);
    }
    ...
    {
      var master = (MaterialObserverExtensions.EntryPoint.Entered) costObserver;
      var clone = new MaterialObserverExtensions.EntryPoint.Entered();
