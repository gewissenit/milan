...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationProcessingMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
    ...
    {
      return new MaterialObserverExtensions.ParallelWorkstation.Processing();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ParallelWorkstation.Processing);
    }
    ...
    {
      var observer = (MaterialObserverExtensions.ParallelWorkstation.Processing) simulationObserver;
    ...
    {
      var master = (MaterialObserverExtensions.ParallelWorkstation.Processing) costObserver;
      var clone = new MaterialObserverExtensions.ParallelWorkstation.Processing();
