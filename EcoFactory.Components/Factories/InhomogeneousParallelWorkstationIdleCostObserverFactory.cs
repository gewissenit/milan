...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationIdleCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousParallelWorkstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousParallelWorkstation.Idle);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousParallelWorkstation.Idle) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousParallelWorkstation.Idle();
