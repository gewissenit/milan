...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationFailureCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Failure"; }
    ...
    {
      return new CostObserverExtensions.Workstation.Failure();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.Workstation.Failure);
    }
    ...
    {
      var master = (CostObserverExtensions.Workstation.Failure) costObserver;
      var clone = new CostObserverExtensions.Workstation.Failure();
