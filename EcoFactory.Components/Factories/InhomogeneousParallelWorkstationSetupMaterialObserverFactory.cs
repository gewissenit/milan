...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationSetupMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new MaterialObserverExtensions.InhomogeneousParallelWorkstation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.InhomogeneousParallelWorkstation.Setup);
    }
    ...
    {
      var master = (MaterialObserverExtensions.InhomogeneousParallelWorkstation.Setup) costObserver;
      var clone = new MaterialObserverExtensions.InhomogeneousParallelWorkstation.Setup();
