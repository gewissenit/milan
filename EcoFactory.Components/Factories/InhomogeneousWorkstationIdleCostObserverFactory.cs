...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationIdleCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousWorkstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousWorkstation.Idle);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousWorkstation.Idle) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousWorkstation.Idle();
