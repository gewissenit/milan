...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationIdleCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new CostObserverExtensions.Workstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.Workstation.Idle);
    }
    ...
    {
      var master = (CostObserverExtensions.Workstation.Idle) costObserver;
      var clone = new CostObserverExtensions.Workstation.Idle();
