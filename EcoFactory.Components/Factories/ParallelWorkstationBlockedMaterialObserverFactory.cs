...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationBlockedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new MaterialObserverExtensions.ParallelWorkstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ParallelWorkstation.Blocked);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ParallelWorkstation.Blocked) costObserver;
      var clone = new MaterialObserverExtensions.ParallelWorkstation.Blocked();
