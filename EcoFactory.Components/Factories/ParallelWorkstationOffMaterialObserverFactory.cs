...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationOffMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new MaterialObserverExtensions.ParallelWorkstation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ParallelWorkstation.Off);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ParallelWorkstation.Off) costObserver;
      var clone = new MaterialObserverExtensions.ParallelWorkstation.Off();
