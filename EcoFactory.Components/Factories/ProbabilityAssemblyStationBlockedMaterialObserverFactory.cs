...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationBlockedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new MaterialObserverExtensions.ProbabilityAssemblyStation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ProbabilityAssemblyStation.Blocked);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ProbabilityAssemblyStation.Blocked) costObserver;
      var clone = new MaterialObserverExtensions.ProbabilityAssemblyStation.Blocked();
