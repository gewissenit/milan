...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationBlockedCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new CostObserverExtensions.ParallelWorkstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.ParallelWorkstation.Blocked);
    }
    ...
    {
      var master = (CostObserverExtensions.ParallelWorkstation.Blocked) costObserver;
      var clone = new CostObserverExtensions.ParallelWorkstation.Blocked();
