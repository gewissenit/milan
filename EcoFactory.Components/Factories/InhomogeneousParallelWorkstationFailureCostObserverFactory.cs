...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationFailureCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Failure"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousParallelWorkstation.Failure();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousParallelWorkstation.Failure);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousParallelWorkstation.Failure) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousParallelWorkstation.Failure();
