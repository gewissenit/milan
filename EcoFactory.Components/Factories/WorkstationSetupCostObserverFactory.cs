...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationSetupCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new CostObserverExtensions.Workstation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.Workstation.Setup);
    }
    ...
    {
      var master = (CostObserverExtensions.Workstation.Setup) costObserver;
      var clone = new CostObserverExtensions.Workstation.Setup();
