...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationOffCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new CostObserverExtensions.ProbabilityAssemblyStation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.ProbabilityAssemblyStation.Off);
    }
    ...
    {
      var master = (CostObserverExtensions.ProbabilityAssemblyStation.Off) costObserver;
      var clone = new CostObserverExtensions.ProbabilityAssemblyStation.Off();
