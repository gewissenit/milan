...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationBlockedCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousParallelWorkstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousParallelWorkstation.Blocked);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousParallelWorkstation.Blocked) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousParallelWorkstation.Blocked();
