...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationOffMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new MaterialObserverExtensions.ProbabilityAssemblyStation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ProbabilityAssemblyStation.Off);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ProbabilityAssemblyStation.Off) costObserver;
      var clone = new MaterialObserverExtensions.ProbabilityAssemblyStation.Off();
