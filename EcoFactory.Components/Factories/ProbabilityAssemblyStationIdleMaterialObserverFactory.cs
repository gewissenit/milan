...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationIdleMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new MaterialObserverExtensions.ProbabilityAssemblyStation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ProbabilityAssemblyStation.Idle);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ProbabilityAssemblyStation.Idle) costObserver;
      var clone = new MaterialObserverExtensions.ProbabilityAssemblyStation.Idle();
