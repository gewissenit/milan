...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ExitPointExitedCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Exited"; }
    ...
    {
      return new CostObserverExtensions.ExitPoint.Exited();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.ExitPoint.Exited);
    }
    ...
    {
      var master = (CostObserverExtensions.ExitPoint.Exited) costObserver;
      var clone = new CostObserverExtensions.ExitPoint.Exited();
