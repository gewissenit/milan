...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationFailureMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Failure"; }
    ...
    {
      return new MaterialObserverExtensions.Workstation.Failure();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.Workstation.Failure);
    }
    ...
    {
      var master = (MaterialObserverExtensions.Workstation.Failure) costObserver;
      var clone = new MaterialObserverExtensions.Workstation.Failure();
