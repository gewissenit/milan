...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationBlockedCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousWorkstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousWorkstation.Blocked);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousWorkstation.Blocked) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousWorkstation.Blocked();
