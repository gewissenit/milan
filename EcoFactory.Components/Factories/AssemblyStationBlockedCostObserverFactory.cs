...
namespace EcoFactory.Components.Factories
{
  ...
  internal class AssemblyStationBlockedCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new CostObserverExtensions.AssemblyStation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.AssemblyStation.Blocked);
    }
    ...
    {
      var master = (CostObserverExtensions.AssemblyStation.Blocked) costObserver;
      var clone = new CostObserverExtensions.AssemblyStation.Blocked();
