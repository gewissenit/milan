...
namespace EcoFactory.Components.Factories
{
  ...
  internal class AssemblyStationIdleCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new CostObserverExtensions.AssemblyStation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.AssemblyStation.Idle);
    }
    ...
    {
      var master = (CostObserverExtensions.AssemblyStation.Idle) costObserver;
      var clone = new CostObserverExtensions.AssemblyStation.Idle();
