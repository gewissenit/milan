...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationIdleMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new MaterialObserverExtensions.ParallelWorkstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ParallelWorkstation.Idle);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ParallelWorkstation.Idle) costObserver;
      var clone = new MaterialObserverExtensions.ParallelWorkstation.Idle();
