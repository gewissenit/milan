...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationProcessingCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
    ...
    {
      return new CostObserverExtensions.InhomogeneousParallelWorkstation.Processing();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousParallelWorkstation.Processing);
    }
    ...
    {
      var observer = (CostObserverExtensions.InhomogeneousParallelWorkstation.Processing) simulationObserver;
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousParallelWorkstation.Processing) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousParallelWorkstation.Processing();
