...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationProcessingMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
    ...
    {
      return new MaterialObserverExtensions.ProbabilityAssemblyStation.Processing();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ProbabilityAssemblyStation.Processing);
    }
    ...
    {
      var observer = (MaterialObserverExtensions.ProbabilityAssemblyStation.Processing) simulationObserver;
    ...
    {
      var master = (MaterialObserverExtensions.ProbabilityAssemblyStation.Processing) costObserver;
      var clone = new MaterialObserverExtensions.ProbabilityAssemblyStation.Processing();
