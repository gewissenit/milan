...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ExitPointExitedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Exited"; }
    ...
    {
      return entity.GetType() == typeof (ExitPoint);
    }

    public IMaterialObserver Create()
    {
      return new MaterialObserverExtensions.ExitPoint.Exited();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ExitPoint.Exited);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ExitPoint.Exited) costObserver;
      var clone = new MaterialObserverExtensions.ExitPoint.Exited();
