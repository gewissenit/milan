...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationIdleMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Idle"; }
    ...
    {
      return new MaterialObserverExtensions.InhomogeneousWorkstation.Idle();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.InhomogeneousWorkstation.Idle);
    }
    ...
    {
      var master = (MaterialObserverExtensions.InhomogeneousWorkstation.Idle) costObserver;
      var clone = new MaterialObserverExtensions.InhomogeneousWorkstation.Idle();
