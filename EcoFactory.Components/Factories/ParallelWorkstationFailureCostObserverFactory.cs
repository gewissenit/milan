...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ParallelWorkstationFailureCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Failure"; }
    ...
    {
      return new CostObserverExtensions.ParallelWorkstation.Failure();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.ParallelWorkstation.Failure);
    }
    ...
    {
      var master = (CostObserverExtensions.ParallelWorkstation.Failure) costObserver;
      var clone = new CostObserverExtensions.ParallelWorkstation.Failure();
