...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationBlockedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new MaterialObserverExtensions.Workstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.Workstation.Blocked);
    }
    ...
    {
      var master = (MaterialObserverExtensions.Workstation.Blocked) costObserver;
      var clone = new MaterialObserverExtensions.Workstation.Blocked();
