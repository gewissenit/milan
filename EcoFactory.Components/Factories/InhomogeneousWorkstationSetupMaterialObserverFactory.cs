...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationSetupMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new MaterialObserverExtensions.InhomogeneousWorkstation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.InhomogeneousWorkstation.Setup);
    }
    ...
    {
      var master = (MaterialObserverExtensions.InhomogeneousWorkstation.Setup) costObserver;
      var clone = new MaterialObserverExtensions.InhomogeneousWorkstation.Setup();
