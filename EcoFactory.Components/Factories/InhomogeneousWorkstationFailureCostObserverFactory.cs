...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationFailureCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Failure"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousWorkstation.Failure();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousWorkstation.Failure);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousWorkstation.Failure) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousWorkstation.Failure();
