...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationSetupMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new MaterialObserverExtensions.ProbabilityAssemblyStation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.ProbabilityAssemblyStation.Setup);
    }
    ...
    {
      var master = (MaterialObserverExtensions.ProbabilityAssemblyStation.Setup) costObserver;
      var clone = new MaterialObserverExtensions.ProbabilityAssemblyStation.Setup();
