...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationSetupCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousParallelWorkstation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousParallelWorkstation.Setup);
    }
    ...
    {
      var observer = (CostObserverExtensions.InhomogeneousParallelWorkstation.Setup) simulationObserver;
      Milan.Simulation.Utils.PrepareEntityObserver(observer);
    }

    private ICostObserver Clone(ISimulationObserver costObserver)
    {
      var master = (CostObserverExtensions.InhomogeneousParallelWorkstation.Setup) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousParallelWorkstation.Setup();
