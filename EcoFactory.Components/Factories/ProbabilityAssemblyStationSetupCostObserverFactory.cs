...
namespace EcoFactory.Components.Factories
{
  ...
  internal class ProbabilityAssemblyStationSetupCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new CostObserverExtensions.ProbabilityAssemblyStation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.ProbabilityAssemblyStation.Setup);
    }
    ...
    {
      var master = (CostObserverExtensions.ProbabilityAssemblyStation.Setup) costObserver;
      var clone = new CostObserverExtensions.ProbabilityAssemblyStation.Setup();
