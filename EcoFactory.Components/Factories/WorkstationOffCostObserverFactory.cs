...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationOffCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new CostObserverExtensions.Workstation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.Workstation.Off);
    }
    ...
    {
      var master = (CostObserverExtensions.Workstation.Off) costObserver;
      var clone = new CostObserverExtensions.Workstation.Off();
