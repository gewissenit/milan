...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationSetupCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new CostObserverExtensions.InhomogeneousWorkstation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.InhomogeneousWorkstation.Setup);
    }
    ...
    {
      var master = (CostObserverExtensions.InhomogeneousWorkstation.Setup) costObserver;
      var clone = new CostObserverExtensions.InhomogeneousWorkstation.Setup();
