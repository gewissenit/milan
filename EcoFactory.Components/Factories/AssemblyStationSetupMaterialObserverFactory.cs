...
namespace EcoFactory.Components.Factories
{
  ...
  internal class AssemblyStationSetupMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Setup"; }
    ...
    {
      return new MaterialObserverExtensions.AssemblyStation.Setup();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.AssemblyStation.Setup);
    }
    ...
    {
      var observer = (MaterialObserverExtensions.AssemblyStation.Setup) simulationObserver;
      Milan.Simulation.Utils.PrepareEntityObserver(observer);
    }

    private IMaterialObserver Clone(ISimulationObserver costObserver)
    {
      var master = (MaterialObserverExtensions.AssemblyStation.Setup) costObserver;
      var clone = new MaterialObserverExtensions.AssemblyStation.Setup();
