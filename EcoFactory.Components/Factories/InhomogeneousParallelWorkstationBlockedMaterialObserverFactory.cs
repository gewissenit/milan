...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationBlockedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new MaterialObserverExtensions.InhomogeneousParallelWorkstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.InhomogeneousParallelWorkstation.Blocked);
    }
    ...
    {
      var master = (MaterialObserverExtensions.InhomogeneousParallelWorkstation.Blocked) costObserver;
      var clone = new MaterialObserverExtensions.InhomogeneousParallelWorkstation.Blocked();
