...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousParallelWorkstationFailureMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Failure"; }
    ...
    {
      return new MaterialObserverExtensions.InhomogeneousParallelWorkstation.Failure();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.InhomogeneousParallelWorkstation.Failure);
    }
    ...
    {
      var master = (MaterialObserverExtensions.InhomogeneousParallelWorkstation.Failure) costObserver;
      var clone = new MaterialObserverExtensions.InhomogeneousParallelWorkstation.Failure();
