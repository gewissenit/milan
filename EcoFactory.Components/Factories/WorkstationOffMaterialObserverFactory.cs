...
namespace EcoFactory.Components.Factories
{
  ...
  internal class WorkstationOffMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Off"; }
    ...
    {
      return new MaterialObserverExtensions.Workstation.Off();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.Workstation.Off);
    }
    ...
    {
      var master = (MaterialObserverExtensions.Workstation.Off) costObserver;
      var clone = new MaterialObserverExtensions.Workstation.Off();
