...
namespace EcoFactory.Components.Factories
{
  ...
  internal class InhomogeneousWorkstationBlockedMaterialObserverFactory : IMaterialObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new MaterialObserverExtensions.InhomogeneousWorkstation.Blocked();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (MaterialObserverExtensions.InhomogeneousWorkstation.Blocked);
    }
    ...
    {
      var master = (MaterialObserverExtensions.InhomogeneousWorkstation.Blocked) costObserver;
      var clone = new MaterialObserverExtensions.InhomogeneousWorkstation.Blocked();
