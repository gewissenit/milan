...
{
  [Export(typeof (ICostObserverFactory))]
  [Export(typeof (ISimulationObserverFactory))]
  internal class WorkstationAwaitingResourcesCostObserverFactory : ICostObserverFactory
  {
    public string Name
    {
      get { return "Blocked"; }
    ...
    {
      return new CostObserverExtensions.Workstation.AwaitingResources();
    }
    ...
    {
      return simulationObserver.GetType() == typeof (CostObserverExtensions.Workstation.AwaitingResources);
    }
    ...
    {
      var master = (CostObserverExtensions.Workstation.AwaitingResources) costObserver;
      var clone = new CostObserverExtensions.Workstation.AwaitingResources();
